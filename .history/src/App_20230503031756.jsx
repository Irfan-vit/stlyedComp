...
function App() {
  ...
  return (
    ...
    // <GlobalStyles>
    <ThemeProvider theme={theme ? darkThemedefaultTheme : }>
      <Button onClick={theme ? setTheme(true) : setTheme(false)}>toggle</Button>
      <div style={{ background: theme ? darkTheme : defaultTheme }}>
        <Hero />
        <FlexCards />
